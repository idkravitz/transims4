//*********************************************************
//	Time_Change.cpp - Create Time Change Report
//*********************************************************
...
void PlanPrep::Time_Change_Header (void)
{
	int i;

	Print (1, "Travel Time Change Report");
	Print (1);
	Print (1, "%27cTime Change * 100 / Previous Time", BLANK);
