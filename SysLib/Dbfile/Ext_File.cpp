//*********************************************************
//	Ext_File.cpp - File Extension Class
//*********************************************************
...
char Ext_File::buffer [] = "";

//---------------------------------------------------------
//	Ext_File constructors
//---------------------------------------------------------

Ext_File::Ext_File (Access_Type access, Format_Type format) : Db_File (access, format)
{
	pathname = NULL;
	extend = 0;
}

Ext_File::Ext_File (char *rootname, Access_Type access, Format_Type format) : Db_File (access, format)
{
	pathname = NULL;
	extend = 0;
...
bool Ext_File::Open (int ext_number)
{
	bool stat, send;
