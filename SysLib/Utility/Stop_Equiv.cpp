//*********************************************************
//	Stop_Equiv.cpp - Process Transit Stop Equivalence Files
//*********************************************************
...
//---------------------------------------------------------
//	Stop_Equiv constructor
//---------------------------------------------------------

Stop_Equiv::Stop_Equiv (void) : Index_Array (sizeof (Group_Data), 10), Db_File ()
{
	File_Type ("Stop Equivalence File");
	max_group = 0;
}

//---------------------------------------------------------
//	Stop_Equiv destructor
//---------------------------------------------------------

Stop_Equiv::~Stop_Equiv (void)
{
	Group_Data *group;
...
char * Stop_Equiv::Group_Label (int group)
{
...
Integer_List * Stop_Equiv::Group_List (int group)
{
	Group_Data *ptr = (Group_Data *) Get (&group);
