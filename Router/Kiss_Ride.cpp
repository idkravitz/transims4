//*********************************************************
//	Kiss_Ride.cpp - build a kiss-&-ride plan
//*********************************************************
...
int Router::Kiss_Ride_Lots (void)
{
	...
	if (kiss_ride.Num_Records () == 0) return (0);
	...
	//---- process each kiss-&-ride lot ----

	for (lot_ptr = kiss_ride.First (); lot_ptr != NULL; lot_ptr = kiss_ride.Next ()) {
		...
		if (ratio > max_kissride) continue;
