//*********************************************************
//	Group_Events.cpp - Group Event Report
//*********************************************************
...
void EventSum::Group_Event_Report (int filter)
{
...
void EventSum::Group_Event_Header (void)
{
	Print (1, "Group Events Greater Than %.2lf", 0);
