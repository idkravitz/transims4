//*********************************************************
//	Top_100_Period.cpp - Create a Top 100 Period Events
//*********************************************************
...
void EventSum::Top_100_Period_Report (void)
{
	...
	Show_Message ("Top 100 Period Event Report -- Link");
	Set_Progress (1000);
...
void EventSum::Top_100_Period_Header (void)
{
	Print (1, "Top 100 Period Event Report");
